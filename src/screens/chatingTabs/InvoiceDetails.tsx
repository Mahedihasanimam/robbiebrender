  ...
  return (
    ...
    <ScrollView style={tw` bg-white`}>
      ...
      <ScrollView contentContainerStyle={tw`p-5`}>
        {/* Header */}
        <View style={tw`mb-2.5 flex flex-row gap-1`}>
        ...
        <View style={tw`flex-row border-b border-[#EEF2FB] py-2 mb-3`}>
          ...
          <Text style={tw`flex-2 text-xs text-gray-400 font-medium text-right`}>
            AMOUNT
          </Text>
        </View>
        ...
        {/* Totals */}
        <View style={tw`mt-2.5 border-t border-[#EEF2FB] pt-4`}>
